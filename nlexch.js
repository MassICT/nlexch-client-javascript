//Create module for NLexch exchange to call the APIs
/*
...
module.exports = (function() {
    ...
    function NLexch(key, secret){
        ...
        this._getPrivateHeaders = function(parameters,link){
            ...
            if (!key || !secret){
                throw 'NLexch: Error. API key and secret required';
            }
    ...
    // NLexch.STRICT_SSL can be set to `false` to avoid this. Use with caution.
    // Will be removed in future, once this is resolved.
    //NLexch.STRICT_SSL = false;

    // Customisable user agent string
    NLexch.USER_AGENT = USER_AGENT;
    ...
    NLexch.prototype = {
        ...
        _privatePost: function(link, parameters, callback){
           ...
           //// console.log(signature + " tonce " + parameters.tonce)
            ...
            options.headers['User-Agent'] = "NLexch API Client/0.0.1"
            return this._request(options, callback);
        },
/////
